...
rm -rf "$LOG_DIR" "$TARBALL_PATH" ./sensor-config.json
...
# pick up sensor config from minio generated by provisioning step above
mc cp myminio/config/1/sensor-config.json ./sensor-config.json
