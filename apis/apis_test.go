...
func cleanupTestDB(t *testing.T) {
    ...
    db2, err := NewDB(cfg.ConnString(), cfg.GetEnvironment())
    if err != nil {
	...
	body           string
	    ...
	    body:           `{"software": {"version":"v1.2.2"},"rules": {"version":"r1.2.2"},"threatintel":{"version":"2025.04.10.153000"}}`,
            ...
            expectedBody: fmt.Sprintf(
                `{"software":{"version":"v1.2.3","size":1024,"digest":"sw-sha256","source":"device","download_url":%q},"rules":{"version":"r1.2.3","size":512,"digest":"rules-sha256","download_url":%q},"threatintel":{"version":"2025.04.10.153010","size":256,"digest":"ti-sha256","download_url":%q}}` + "\n",
        ...
        },
        {
            ...
            deviceID:       "dev1",
            tenantID:       "1",
	    body:           `{"software": {"version":"v1.2.2"},"rules": {"version":"r1.2.3", "digest":"rules-sha256"},"threatintel":{"version":"2025.04.10.153020"}}`,
            expectedStatus: http.StatusOK,
            expectedBody: fmt.Sprintf(
        ...
        },
        {
            ...
            deviceID:       "dev1",
            tenantID:       "1",
	    body:           `{"software": {"version":"v1.2.3", "digest":"sw-sha256"},"rules": {"version":"r1.2.2"},"threatintel":{"version":"2025.04.10.153020"}}`,
            expectedStatus: http.StatusOK,
            expectedBody: fmt.Sprintf(
	        `{"rules":{"version":"r1.2.3","size":512,"digest":"rules-sha256","download_url":%q}}` + "\n",
                DownloadURLFormatRules(1, "rules", "hndr-rules", "r1.2.3"),
	    ),
        },
        {
            ...
            deviceID:       "dev1",
            tenantID:       "1",
	    body:           `{"software": {"version":"v1.2.3", "digest":"sw-sha256"},"rules": {"version":"r1.2.3", "digest": "rules-sha256"},"threatintel":{"version":"2025.04.10.153000"}}`,
            expectedStatus: http.StatusOK,
            expectedBody: fmt.Sprintf(
	        `{"threatintel":{"version":"2025.04.10.153010","size":256,"digest":"ti-sha256","download_url":%q}}` + "\n",
                DownloadURLFormat(1, "threatintel", "threatintel", "2025.04.10.153010"),
	    ),
        },
        {
	    ...
	    body:           `{"software": {"version":"v1.2.2"},"rules": {"version":"r1.2.3","digest":"rules-sha256"},"threatintel":{"version":"2025.04.10.153020"}}`,
            expectedStatus: http.StatusOK,
            expectedBody: fmt.Sprintf(
	        `{"software":{"version":"v1.2.4","size":1234,"digest":"sw-sha256","source":"latest","download_url":%q}}` + "\n",
        ...
        },
        {
            ...
            deviceID:       "dev1",
            tenantID:       "1",
	    body:           `{"software": {"version":"v1.2.3", "digest": "foobar"},"rules": {"version":"r1.2.3", "digest":"rules-sha256"},"threatintel":{"version":"2025.04.10.153020"}}`,
            expectedStatus: http.StatusOK,
            expectedBody: fmt.Sprintf(
	        `{"software":{"version":"v1.2.3","size":1024,"digest":"sw-sha256","source":"device","download_url":%q}}` + "\n",
                DownloadURLFormat(1, "software", "hndr-sw", "v1.2.3"),
