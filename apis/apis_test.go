...
func TestUpdate(t *testing.T) {
	...
	body           string
    ...
    }{
        {
            ...
            deviceID:       "dev1",
            tenantID:       "1",
	    body:           `{"image": {"version":"v1.2.2"},"rules": {"version":"r1.2.2"},"threatfeed":{"version":"2025.04.10.153000"}}`,
            expectedStatus: http.StatusOK,
        ...
        },
        {
            ...
            deviceID:       "dev1",
            tenantID:       "1",
	    body:           `{"image": {"version":"v1.2.10"},"rules": {"version":"r1.2.20"},"threatfeed":{"version":"2025.04.10.153020"}}`,
            expectedStatus: http.StatusOK,
	    expectedBody:   `{}` + "\n",
        },
        {
            ...
            deviceID:       "dev1",
            tenantID:       "1",
	    body:           `{"image": {"version":"v1.2.2"},"rules": {"version":"r1.2.3"},"threatfeed":{"version":"2025.04.10.153020"}}`,
            expectedStatus: http.StatusOK,
            expectedBody: fmt.Sprintf(
	        `{"image":{"version":"v1.2.3","size":1024,"sha256":"sw-sha256","source":"device","download_url":%q}}` + "\n",
                DownloadURLFormat(1, "images", "hndr-sw", "v1.2.3"),
	    ),
        },
        {
            ...
            deviceID:       "dev1",
            tenantID:       "1",
	    body:           `{"image": {"version":"v1.2.3"},"rules": {"version":"r1.2.2"},"threatfeed":{"version":"2025.04.10.153020"}}`,
            expectedStatus: http.StatusOK,
            expectedBody: fmt.Sprintf(
        ...
        },
        {
            ...
            deviceID:       "dev1",
            tenantID:       "1",
	    body:           `{"image": {"version":"v1.2.3"},"rules": {"version":"r1.2.3"},"threatfeed":{"version":"2025.04.10.153000"}}`,
            expectedStatus: http.StatusOK,
            expectedBody: fmt.Sprintf(
	        `{"threatfeed":{"version":"2025.04.10.153010","size":256,"sha256":"ti-sha256","download_url":%q}}` + "\n",
                DownloadURLFormat(1, "threatintel", "threatintel", "2025.04.10.153010"),
	    ),
        },
        {
            ...
            deviceID:       "dev1",
            tenantID:       "1",
	    body:           `{"image": {"version":"v1.2.2"},"rules": {"version":"r1.2.3"},"threatfeed":{"version":"2025.04.10.153000"}}`,
            expectedStatus: http.StatusUnauthorized,
	    expectedBody:   "Unauthorized: failed to validate API key\n",
        },
        {
        ...
        },
        {
            ...
            deviceID:       "dev1",
            tenantID:       "1",
	    body:           `{"image":{"version":"v1.2.2"}, "rules":{"version": "invalid json"`,
	    ...
	    body:           `{"image": {"version":"v1.2.2"},"rules": {"version":"r1.2.3"},"threatfeed":{"version":"2025.04.10.153020"}}`,
            expectedStatus: http.StatusOK,
            expectedBody: fmt.Sprintf(
	        `{"image":{"version":"v1.2.4","size":1234,"sha256":"sw-sha256","source":"latest","download_url":%q}}` + "\n",
