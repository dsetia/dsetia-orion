...
func TestUpdate(t *testing.T) {
	...
	body           string
    ...
    }{
        {
            ...
            deviceID:       "dev1",
            tenantID:       "1",
	    body:           `{"image_version":"v1.2.2","rules_version":"r1.2.2","threatfeed_version":"2025.04.10.153000"}`,
            expectedStatus: http.StatusOK,
            expectedBody: fmt.Sprintf(
                `{"software":{"version":"v1.2.3","size":1024,"sha256":"sw-sha256","source":"device","download_url":%q},"rules":{"version":"r1.2.3","size":512,"sha256":"rules-sha256","download_url":%q},"threat_intel":{"version":"2025.04.10.153010","size":256,"sha256":"ti-sha256","download_url":%q}}` + "\n",
        ...
        },
        {
            ...
            deviceID:       "dev1",
            tenantID:       "1",
            body:           `{"image_version":"v1.2.10","rules_version":"r1.2.20","threatfeed_version":"2025.04.10.153020"}`,
            expectedStatus: http.StatusOK,
	    expectedBody:   `{}` + "\n",
        },
        {
        ...
        },
        {
            ...
            deviceID:       "dev1",
            tenantID:       "1",
            body:           `{"image_version":"v1.2.3","rules_version":"r1.2.2","threatfeed_version":"2025.04.10.153020"}`,
            expectedStatus: http.StatusOK,
            expectedBody: fmt.Sprintf(
        ...
        },
        {
            ...
            deviceID:       "dev1",
            tenantID:       "1",
            body:           `{"image_version":"v1.2.3","rules_version":"r1.2.3","threatfeed_version":"2025.04.10.153000"}`,
            expectedStatus: http.StatusOK,
            expectedBody: fmt.Sprintf(
	        `{"threat_intel":{"version":"2025.04.10.153010","size":256,"sha256":"ti-sha256","download_url":%q}}` + "\n",
                DownloadURLFormat(1, "threatintel", "threatintel", "2025.04.10.153010"),
	    ),
        },
        {
            ...
            deviceID:       "dev1",
            tenantID:       "1",
	    body:           `{"image_version":"v1.2.2","rules_version":"2025.03.01","threatfeed_version":"2025.04.01.001"}`,
            expectedStatus: http.StatusUnauthorized,
	    expectedBody:   "Unauthorized: failed to validate API key\n",
        },
        {
